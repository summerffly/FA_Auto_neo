...
string  CMD_HELP_CHECK_EXMONTH  = CHECK + " " + EXMONTH;
string  CMD_HELP_UPDATE_EXMONTH = UPDATE + " " + EXMONTH;
string  CMD_HELP_SHOW_EXMONTH = SHOW + " " + EXMONTH;
...
string  CMD_HELP_PATCH_CHECK_TITLE = "TT = " + DK + "/" + NS + "/" + NR + "/" + TRAVEL;
...
string  CMD_HELP_PATCH_PRINT_TITLE = "TT = " + DK + "/" + NS + "/" + NR + "/" + TRAVEL;
